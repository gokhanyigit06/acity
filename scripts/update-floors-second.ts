...
const storesToUpdate = [
    "Armağan Oyuncak", "Atış Poligonu", "Balon Evi", "Bosch", "Bubble Tea",
    "Bursa Kebap Evi", "Cinema", "Çaytaze", "Çocuk Atölye", "D&R Music & Book Store",
    "Eğlence Adası", "HD İskender", "Kahveci", "Kayseri Mutfağı", "Korku Evi",
    "Lahmacun Mola", "LG", "McDonald’s", "Meywa Waffle", "Öküz Burger",
    "Pideli", "Popeyes", "Riva Balo ve Nikah Salonu", "Rossmann", "Samsung",
    "Siemens", "Sbarro", "Softplay", "Terra Pizza", "Tavuk Dünyası",
    "Trambolin", "TTO Kozmetik", "Vestel", "Yaprak Döner", "Yemenli"
];

async function updateFloorsSecond() {
